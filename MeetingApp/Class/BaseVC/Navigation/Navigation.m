...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (self.childViewControllers.count > 0) { // 非根控制器
        ...
        UIBarButtonItem *leftButon = [UIBarButtonItem backItemWithimage:[UIImage imageNamed:@"黑色箭头"] highImage:[UIImage imageNamed:@"黑色箭头"]  target:self action:@selector(popView) title:@" "];;
